...
export function ResourceMap({ activeResourceId = null, onSelectResource }: ResourceMapProps) {
  ...
  useEffect(() => {
    ...
    mapRef.current.flyTo([activeResource.lat, activeResource.lng], ACTIVE_ZOOM, {
      duration: 0.6,
    });
  }, [activeResource]);
        ...
        {mockResources.map((resource) => {
          ...
          return (
            <CircleMarker
              ...
              pathOptions={{
                ...markerStylesByType[resource.type],
                weight: isActive ? 3 : markerStylesByType[resource.type].weight,
              }}
